function showInfo(data, tabletop) {
  ...
  $.each( tabletop.sheets(), function(i, sheet) 
  {
    ...
    for(i = 0; i < rows; i++ ) 
    {
      ...
      var twitter = '<a href="#" onclick="window.open(\'https://twitter.com/share?url=http://deldichoalhecho.cl/&amp;via=ciudadanoi&amp;text='+promesa+'\',\'twitter\',\'width=450, height=250\')"><i class="fa fa-twitter"></i> twitter</a>';    
